(function (factory) {
    ...
    Map.prototype.asLinq = function () {
        return (new Linq.LinqIterableProxy(this)).select(function (x) { return new Linq.KeyValuePair(x[0], x[1]); });
    };
    Object.prototype.asLinq = function () {
        var that = this;
        return Object.keys(this).asLinq().select(function (k) { return new Linq.KeyValuePair(k, that[k]); });
    };
});
/*
